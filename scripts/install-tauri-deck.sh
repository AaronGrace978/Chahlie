...
echo "══════════════════════════════════════════════════════"
echo "  cd ~/Downloads"
echo "  curl -L -O https://github.com/AaronGrace978/Chahlie/releases/download/v2.6.3/chahlie-deck-2.6.3-linux-x86_64.tar.gz"
echo "  tar -xzf chahlie-deck-2.6.3-linux-x86_64.tar.gz"
echo "  cd chahlie-deck-2.6.3-linux && ./START-CHAHLIE.sh"
echo ""
